...
const submitData=async()=>{
  try {
    const response= await axios.post(`${server_url}/api/principal/addStudents`,studentsData);
...
const handleChange = (e) => {
  ...
  useEffect(()=>{
      ...
      const fetchSectionNames=async()=>
        {
            const response= await axios.post(`${server_url}/api/admin/getSections`, studentsData );
